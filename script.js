...
function renderTable() {
    ...
    const columns = [
        ...
        'info_fail','if_not_work','part_change','act_work','ini_work','fin_work',
        'heat_from','heat_target','heat_test','hum_low','hum_high','hum_test',
        'temp_high','temp_low','cold_test','pulldown','notes','name_esp','name_cus',
